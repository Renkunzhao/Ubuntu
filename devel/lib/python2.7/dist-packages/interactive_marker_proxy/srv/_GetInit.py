...
"""autogenerated by genpy from interactive_marker_proxy/GetInitRequest.msg. Do not edit."""
import codecs
import sys
...
class GetInitRequest(genpy.Message):
  _md5sum = "d41d8cd98f00b204e9800998ecf8427e"
  _type = "interactive_marker_proxy/GetInitRequest"
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetInitRequest, self).__init__(*args, **kwds)
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from interactive_marker_proxy/GetInitResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class GetInitResponse(genpy.Message):
  _md5sum = "4880f9fbacc796ee9d6c08994daf3e3c"
  _type = "interactive_marker_proxy/GetInitResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """visualization_msgs/InteractiveMarkerInit msg
...
"""
  __slots__ = ['msg']
  _slot_types = ['visualization_msgs/InteractiveMarkerInit']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GetInitResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.msg is None:
        self.msg = visualization_msgs.msg.InteractiveMarkerInit()
    else:
      self.msg = visualization_msgs.msg.InteractiveMarkerInit()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.msg.markers)
      buff.write(_struct_I.pack(length))
      for val1 in self.msg.markers:
        _v1 = val1.header
        _x = _v1.seq
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.msg.server_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.msg.server_id = str[start:end]
      start = end
      end += 8
      (self.msg.seq_num,) = _get_struct_Q().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.msg.markers = []
...
class GetInit(object):
  _type          = 'interactive_marker_proxy/GetInit'
  _md5sum = '4880f9fbacc796ee9d6c08994daf3e3c'
  _request_class  = GetInitRequest
  _response_class = GetInitResponse
